...
CREATE USER 'ssbd03admin'@'%' IDENTIFIED BY 'admin';
CREATE USER 'ssbd03auth'@'%' IDENTIFIED BY 'auth';
CREATE USER 'ssbd03mok'@'%' IDENTIFIED BY 'mok';
CREATE USER 'ssbd03mop'@'%' IDENTIFIED BY 'mop';

GRANT ALL PRIVILEGES ON ssbd03.* TO 'ssbd03admin'@'%' WITH GRANT OPTION;
...
GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE past_password          TO 'ssbd03mok'@'%';
GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE personal_data          TO 'ssbd03mok'@'%';
GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE user_level             TO 'ssbd03mok'@'%';
GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE client_data            TO 'ssbd03mok'@'%';
GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE staff_data             TO 'ssbd03mok'@'%';
GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE admin_data             TO 'ssbd03mok'@'%';
GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE token                  TO 'ssbd03mok'@'%';
GRANT SELECT, INSERT                 ON TABLE account_history        TO 'ssbd03mok'@'%';

GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE account_attributes     TO 'ssbd03mok'@'%';
GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE attribute_association  TO 'ssbd03mok'@'%';
GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE attribute_name         TO 'ssbd03mok'@'%';
GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE attribute_value        TO 'ssbd03mok'@'%';

GRANT SELECT                         ON TABLE account_attributes     TO 'ssbd03auth'@'%';
GRANT SELECT                         ON TABLE attribute_association  TO 'ssbd03auth'@'%';
GRANT SELECT                         ON TABLE attribute_name         TO 'ssbd03auth'@'%';
GRANT SELECT                         ON TABLE attribute_value        TO 'ssbd03auth'@'%';

GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE reservation            TO 'ssbd03mop'@'%';
GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE parking                TO 'ssbd03mop'@'%';
GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE sector                 TO 'ssbd03mop'@'%';
GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE parking_event          TO 'ssbd03mop'@'%';
GRANT SELECT                         ON TABLE account                TO 'ssbd03mop'@'%';
GRANT SELECT                         ON TABLE personal_data          TO 'ssbd03mop'@'%';
GRANT SELECT                , UPDATE ON TABLE user_level             TO 'ssbd03mop'@'%';
GRANT SELECT                , UPDATE ON TABLE client_data            TO 'ssbd03mop'@'%';
GRANT SELECT                         ON TABLE admin_data             TO 'ssbd03mop'@'%';
GRANT SELECT                         ON TABLE staff_data             TO 'ssbd03mop'@'%';
GRANT SELECT, INSERT                 ON TABLE parking_history        TO 'ssbd03mop'@'%';

GRANT SELECT                         ON TABLE account_attributes     TO 'ssbd03mop'@'%';
GRANT SELECT                         ON TABLE attribute_association  TO 'ssbd03mop'@'%';
GRANT SELECT                         ON TABLE attribute_name         TO 'ssbd03mop'@'%';
GRANT SELECT                         ON TABLE attribute_value        TO 'ssbd03mop'@'%';


GRANT SELECT, UPDATE                 ON TABLE account                TO 'ssbd03auth'@'%';
GRANT SELECT                         ON TABLE personal_data          TO 'ssbd03auth'@'%';
GRANT SELECT                         ON TABLE user_level             TO 'ssbd03auth'@'%';
GRANT SELECT                         ON TABLE client_data            TO 'ssbd03auth'@'%';
GRANT SELECT                         ON TABLE staff_data             TO 'ssbd03auth'@'%';
GRANT SELECT                         ON TABLE admin_data             TO 'ssbd03auth'@'%';
GRANT SELECT, INSERT, DELETE         ON TABLE token                  TO 'ssbd03auth'@'%';
GRANT SELECT, INSERT                 ON TABLE account_history        TO 'ssbd03auth'@'%';