...
-- Parking
INSERT INTO public.parking (id, creation_timestamp, sector_strategy, zip_code, city, street, version) VALUES ('96a36faa-f2a2-41b8-9c3c-b6bef04ce6d1', current_timestamp, 'LEAST_OCCUPIED', '91-416', 'Łódź', 'Palki', 0);
INSERT INTO public.parking (id, creation_timestamp, sector_strategy, zip_code, city, street, version) VALUES ('a54e7ae6-ba2c-4fac-8ef6-e9d27da48921', current_timestamp, 'LEAST_OCCUPIED', '75-626', 'Łódź', 'Pomorska', 0);
INSERT INTO public.parking (id, creation_timestamp, sector_strategy, zip_code, city, street, version) VALUES ('ddcae4ec-aeb5-4ece-aa2b-46819763d55f', current_timestamp, 'LEAST_OCCUPIED', '95-010', 'Stryków', 'Krótka', 0);

-- First Sector S1
INSERT INTO public.sector (id, creation_timestamp ,occupied_places, max_places, weight, name, parking_id, type, version, deactivation_time) VALUES ('3e6a85db-d751-4549-bbb7-9705f0b2fa6b', current_timestamp, 0, 50, 1, 'SA-01', '96a36faa-f2a2-41b8-9c3c-b6bef04ce6d1', 'UNCOVERED', 0, current_timestamp - interval '2 hours');

-- Second Sector S1
INSERT INTO public.sector (id, creation_timestamp, occupied_places, max_places, weight, name, parking_id, type, version) VALUES ('9f7f2969-1b7e-4bb3-ab84-6dbc31c01277', current_timestamp, 0, 50, 1, 'SB-01', '96a36faa-f2a2-41b8-9c3c-b6bef04ce6d1', 'UNCOVERED', 0);

-- Third Sector S1
INSERT INTO public.sector (id, creation_timestamp, occupied_places, max_places, weight, name, parking_id, type, version) VALUES ('99023647-d8d2-43a5-91c7-b24781f06e13', current_timestamp, 0, 50, 1, 'SB-02', 'a54e7ae6-ba2c-4fac-8ef6-e9d27da48921', 'UNCOVERED', 0);

-- Fourth Sector S1
INSERT INTO public.sector (id, creation_timestamp, occupied_places, max_places, weight, name, parking_id, type, version) VALUES ('bca50310-f4fb-4911-bf3c-68e00e517b95', current_timestamp, 0, 50, 1, 'SB-03', 'a54e7ae6-ba2c-4fac-8ef6-e9d27da48921', 'UNCOVERED', 0);

-- Fifth Sector S1
INSERT INTO public.sector (id, creation_timestamp, occupied_places, max_places, weight, name, parking_id, type, version) VALUES ('82b4ad91-a5ef-48bf-bc5b-390d7f4d1dea', current_timestamp, 0, 50, 1, 'SB-04', 'a54e7ae6-ba2c-4fac-8ef6-e9d27da48921', 'COVERED', 0);

-- Sixth Sector S1
INSERT INTO public.sector (id, creation_timestamp, occupied_places, max_places, weight, name, parking_id, type, version) VALUES ('36e19dcd-1d5b-4258-a5df-ba9f4372c58c', current_timestamp, 0, 50, 1, 'SB-05', 'a54e7ae6-ba2c-4fac-8ef6-e9d27da48921', 'UNDERGROUND', 0);

-- Seventh Sector S2
INSERT INTO public.sector (id, creation_timestamp, occupied_places, max_places, weight, name, parking_id, type, version) VALUES ('4ce920a0-6f4d-4e95-ba24-99ba32b66491', current_timestamp, 0, 60, 2, 'SA-02', '96a36faa-f2a2-41b8-9c3c-b6bef04ce6d1', 'UNCOVERED', 0);

-- Eighth Sector S3
INSERT INTO public.sector (id, creation_timestamp, occupied_places, max_places, weight, name, parking_id, type, version) VALUES ('c51557aa-284d-44a6-b38d-b6ceb9c23725', current_timestamp, 0, 70, 3, 'SA-03', '96a36faa-f2a2-41b8-9c3c-b6bef04ce6d1', 'UNCOVERED', 0);
...
INSERT INTO public.parking (id, creation_timestamp, sector_strategy, zip_code, city, street, version) VALUES ('2480e8a1-165f-4824-b6ae-11d10b0da04f', current_timestamp, 'LEAST_OCCUPIED', '90-431', 'Warszawa', 'Rezerwowa', 0);
...
INSERT INTO public.parking (id, creation_timestamp, sector_strategy, zip_code, city, street, version) VALUES ('1a91f421-4cff-449b-837c-adbaf182689b', current_timestamp, 'LEAST_OCCUPIED', '57-143', 'Łódź', 'Wólczańska', 0);
...
INSERT INTO public.parking (id, creation_timestamp, sector_strategy, zip_code, city, street, version) VALUES ('c94a751b-77e3-4a4d-bb64-74bfbe9c8857', current_timestamp, 'MOST_OCCUPIED', '21-582', 'Łódź', 'Piłsudskiego', 0);
