...
-- INSERT VALUE
-- Admin
INSERT INTO public.account (id, login, password, verified, active, language, phone_number, creation_date, version, blocked) VALUES ('b3b8c2ac-21ff-434b-b490-aa6d717447c0', 'jbem', 'P@ssw0rd!', true, true, 'PL', '111111111', current_date, 0, false);
...
-- Staff
INSERT INTO public.account (id, login, password, verified, active, language, phone_number, creation_date, version, blocked) VALUES ('e0bf979b-6b42-432d-8462-544d88b1ab5f', 'kslimak', 'P@ssw0rd!', true, true, 'PL', '222222222', current_date, 0, false);
...
-- First Client
INSERT INTO public.account (id, login, password, verified, active, language, phone_number, creation_date, version, blocked) VALUES ('0ca02f7e-d8e9-45d3-a332-a56015acb822', 'mkowal', 'P@ssw0rd!', true, true, 'PL', '000000000', current_date, 0, false);
...
-- Second Client
INSERT INTO public.account (id, login, password, verified, active, language, phone_number, creation_date, version, blocked) VALUES ('902d6e5b-2449-4898-a4f7-a92b0d8a04e1', 'jkoza', 'P@ssw0rd!', true, true, 'PL', '000000001', current_date, 0, false);
...
-- Third Client
INSERT INTO public.account (id, login, password, verified, active, language, phone_number, creation_date, version, blocked) VALUES ('02b0d9d7-a472-48d0-95e0-13a3e6a11d00', 'pnowak', 'P@ssw0rd!', true, true, 'PL', '000000003', current_date, 0, false);
