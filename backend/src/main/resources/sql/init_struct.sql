...
--
-- Name: parking_history; Type: TABLE; Schema: public; Owner: ssbd03admin
--
...
CREATE TABLE public.parking_history (
                                        ...
                                        CONSTRAINT parking_history_strategy_check CHECK (((strategy)::text = ANY ((ARRAY['LEAST_OCCUPIED'::character varying, 'MOST_OCCUPIED'::character varying, 'LEAST_OCCUPIED_WEIGHTED'::character varying])::text[])))
);


ALTER TABLE public.parking_history OWNER TO ssbd03admin;
...
--
-- Name: parking_history parking_history_pkey; Type: CONSTRAINT; Schema: public; Owner: ssbd03admin
--
...
--
-- Name: idx_parking_history_account_id; Type: INDEX; Schema: public; Owner: ssbd03admin
--

CREATE INDEX idx_parking_history_account_id ON public.parking_history USING btree (modified_by);
...
--
-- Name: parking_history parking_history_account_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: ssbd03admin
--

ALTER TABLE ONLY public.parking_history
    ADD CONSTRAINT parking_history_account_id_fk FOREIGN KEY (modified_by) REFERENCES public.account(id);
