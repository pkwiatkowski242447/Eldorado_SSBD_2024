...
public interface RegistrationControllerInterface {
     ...
     * @return If account registration is successful, then 201 CREATED is returned as a response. In case of Persistence exception being thrown
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "New user account with client user level was created successfully and account activation message was sent."),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "New user account with staff user level was created successfully and account activation message was sent."),
            @ApiResponse(responseCode = "400", description = "New user account with given data could not be created."),
            @ApiResponse(responseCode = "409", description = "User account with given login or password already exists."),
            @ApiResponse(responseCode = "500", description = "Unknown error occurred while the request was being processed.")
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "New user account with admin user level was created successfully and account activation message was sent."),
            @ApiResponse(responseCode = "400", description = "New user account with given data could not be created."),
            @ApiResponse(responseCode = "409", description = "User account with given login or password already exists."),
            @ApiResponse(responseCode = "500", description = "Unknown error occurred while the request was being processed.")
    })
