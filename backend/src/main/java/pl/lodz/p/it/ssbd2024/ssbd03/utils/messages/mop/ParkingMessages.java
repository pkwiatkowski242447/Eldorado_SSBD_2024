...
public class ParkingMessages {
    ...
    public static final String ADDRESS_NULL = "bean.validation.parking.address.null";
    public static final String SECTOR_STRATEGY_NULL = "bean.validation.parking.sector.strategy.null";
