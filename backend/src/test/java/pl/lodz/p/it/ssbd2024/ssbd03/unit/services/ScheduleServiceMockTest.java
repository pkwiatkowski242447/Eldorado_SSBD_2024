...
public class ScheduleServiceMockTest {
    ...
    @Test
    void deleteNotVerifiedTestSuccessful() throws ScheduleBadProperties {
    ...
    @Test
    void deleteNotVerifiedTestEmpty() throws ScheduleBadProperties {
    ...
    @Test
    void unblockAccountTestSuccessful() throws NoSuchFieldException, IllegalAccessException, ScheduleBadProperties {
        Account account = new Account("login", "TestPassword", "firstName", "lastName", "test@email.com", "123123123");
        Account account1 = new Account("login1", "TestPassword1", "firstName1", "lastName1", "test1@email.com", "123123124");
        account.setAccountLanguage("pl");
        account1.setAccountLanguage("en");
    ...
    @Test
    void unblockAccountTestEmpty() throws NoSuchFieldException, IllegalAccessException, ScheduleBadProperties {
        List<Account> accountList = new ArrayList<>();
